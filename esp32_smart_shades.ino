...
// BLE
// The remote Battery service we wish to connect to.
// 0000180f-0000-1000-8000-00805f9b34fb
static BLEUUID serviceUUID("0000180f-0000-1000-8000-00805f9b34fb");
// The Battery characteristic of the remote service we are interested in.
...
//    Serial.println("sending MQTT stats");
//    mqtt.publish( (base_topic + "esp32" + F("/$name")).c_str(), "" , true);
//    mqtt.publish( (base_topic + "esp32" + F("/$localip")).c_str(), "", true);
//    mqtt.publish( (base_topic + "esp32" + F("/$mac")).c_str(), "", true);
//    mqtt.publish( (base_topic + "esp32" + F("/$arch")).c_str(), "", true);
//    mqtt.publish( (base_topic + "esp32" + F("/$sdk")).c_str(), "", true);
//    mqtt.publish( (base_topic + "esp32" + F("/$fwversion")).c_str(), "", true);
//    mqtt.publish( (base_topic + "esp32" + F("/$online")).c_str(), "", true);    
